...
/* Definitions for Navigation_Task */
...
/**
  * @brief  Function implementing the Sensing_Task thread.
...
/* USER CODE BEGIN Header_Motion_Control */
/**
* @brief Function implementing the Navigation_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Motion_Control */
void Motion_Control(void *argument)
{
